...
namespace DataModel.GenericRepository
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        {
            if (context == null)
                System.Diagnostics.Debug.WriteLine("DBContext is null"); 
            else
                System.Diagnostics.Debug.WriteLine("DBContext is not null");
        ...
        /// </summary>         /// <param name="where"></param>         
        /// <returns></returns>         
        ...
        /// </summary>         /// <param name="primaryKey"></param>         
        /// <returns></returns>         
